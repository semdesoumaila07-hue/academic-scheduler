        ...
        try:
            ...
            for row,(rid,name,cap,rtype,building,is_active) in enumerate(rooms):
                ...
                for label,color_btn,cb in [
                    ("Dispo","#3B82F6",lambda checked=False,r=rid,n=name:self._show_avail(r,n)),
                    ("Modifier","#F59E0B",lambda checked=False,r=rid:self._edit_room(r)),
                    ("Supprimer","#EF4444",lambda checked=False,r=rid,n=name:self._delete_room(r,n))]:
                    b = QPushButton(label)
                    b.setFixedHeight(26)
...
class RoomDialog(QDialog):
    ...
    def _build(self):
        ...
        self.inp_cap=QSpinBox(); self.inp_cap.setRange(1,5000); self.inp_cap.setValue(30); self.inp_cap.setFixedHeight(34)
